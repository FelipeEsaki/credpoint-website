const servicos = [
    ...
    },
    {
        ...
        servico: 'Seguros',
        texto: `A CredPoint possui <strong>todos os tipos de seguros</strong> e <strong>mais de 10 seguradoras</strong> parceiras para melhor atender sua necessidade!`
    },
    {
        imagem: `//img.icons8.com/ios/100/money-transfer.png`,
        servico: 'Consórcios',
        texto: `A CredPoint oferece a <strong>melhor opção de consórcio</strong> de acordo com sua necessidade. Trabalhamos com todos os tipos de consórcios!`
    },
    {
    ...
    },
    {
        ...
        texto: `Está na hora de adquirir seu <strong>novo veículo</strong>! Com a CredPoint você tem as <strong>melhores taxas</strong> e opções de financiamento!`
    },
    {
        imagem: `//img.icons8.com/ios/100/cottage--v1.png`,
        servico: 'Financiamento Residencial',
        texto: `Está na hora de adquirir sua <strong>nova casa</strong>! Com a CredPoint você tem as <strong>melhores taxas</strong> e opções de financiamento e refinanciamento residencial!`
    },
    {
